...
FPoint map_coverage::UniformRandomPointInTriangle(
...
FPoint map_coverage::UniformRandomPointInRandomTriangle(
...
FPoint map_coverage::UniformRandomPointInRandomTriangle(
    ...
    return UniformRandomPointInRandomTriangle(triangles, const_cast<const std::vector<double> &>(accum_areas), rng);
}
