...
namespace parsers {
    ...
    // Struct of vertex using geom library
    struct GeomVertex {
    ...
    // Struct of polygon using geom library
    struct GeomPolygon {
        // Polygon represented in geom library
    ...
    // Structure describe mesh using geom library
    struct GeomMesh {
        int formatVersion = 2;
