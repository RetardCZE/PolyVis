...
#ifndef TRIVIS_EXAMPLES_DRAWING_CAIRO_GEOM_DRAWER_H_
#define TRIVIS_EXAMPLES_DRAWING_CAIRO_GEOM_DRAWER_H_
...
public:
    ...
    template<typename T>
    void DrawPoint(
        const trivis::core::geom::Point<T> &p,
        const T &radius = T(1),
    ...
    template<typename T>
    void DrawPoints(
        const trivis::core::geom::Points<T> &points,
        const T &radius = T(1),
        const RGB &fill_color = kColorBlack,
        double opacity = 1.0
    ) const {
    ...
    template<typename T>
    void DrawLine(
        const trivis::core::geom::Point<T> &p1,
        const trivis::core::geom::Point<T> &p2,
    ...
    template<typename T>
    void DrawPath(
        const trivis::core::geom::Points<T> &path,
        const T &line_width = T(1),
        const RGB &line_color = kColorBlack,
        double opacity = 1.0
    ) const {
    ...
    template<typename T>
    void DrawPolygon(
        const trivis::core::geom::Polygon<T> &poly,
        const RGB &fill_color = kColorBlack,
        double opacity = 1.0
    ) const {
    ...
    template<typename T>
    void DrawPolygons(
        const trivis::core::geom::Polygons<T> &poly,
        const RGB &fill_color = kColorBlack,
        double opacity = 1.0
    ) const {
...
private:
    ...
    template<typename T>
    void DrawPolygons(
        const trivis::core::geom::Polygons<T> &polys,
        bool fill,
        const RGB &fill_color,
        bool stroke,
        const T &line_width,
...
#endif //TRIVIS_EXAMPLES_DRAWING_CAIRO_GEOM_DRAWER_H_
