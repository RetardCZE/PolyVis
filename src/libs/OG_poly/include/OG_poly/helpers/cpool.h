...
class cpool
{
    public:
        ...
        allocate()
        {
            ...
            if(!mem_ptr)
            {
                ...
                add_chunk(OGwarthog::mem::DEFAULT_CHUNK_SIZE);
        ...
        mem()
        {
            ...
            bytes += sizeof(OGwarthog::mem::cchunk*)*max_chunks_;
            bytes += sizeof(*this);
            return bytes;
        }
        ...
        print(std::ostream& out)
        {
            out << "OGwarthog::mem::cpool #chunks: "<<num_chunks_
    ...
    private:
        OGwarthog::mem::cchunk** chunks_;
        OGwarthog::mem::cchunk* current_chunk_;
        ...
        // no copy
        cpool(const OGwarthog::mem::cpool& other) { }
        OGwarthog::mem::cpool&
        operator=(const OGwarthog::mem::cpool& other) { return *this; }
