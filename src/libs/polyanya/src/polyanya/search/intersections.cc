 ...
 *
 * Edited by Jakub Rosol.
 * (Added LineSegmentIntersectionGeneral and SegmentSegmentIntersectionGeneral but did not used them in the end)
 */
#include "polyanya/search/intersections.h"
