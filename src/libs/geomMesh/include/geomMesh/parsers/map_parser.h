...
namespace parsers {
    ...
    public:
         ...
         */
        void convertMapToFade2DMesh(const std::string &filename, Fade2DMesh &fade2DMesh, int &numObst);
        ...
        /**
         * Convert  map (e.g. potholes.txt) to draw mesh
         * @param filename name of the file
         * @param geomMesh output draw mesh structure
         */
        ...
        /**
         * Convert fade 2d mesh to draw mesh
         * @param fade2DMesh struct
        ...
        /**
         * Convert merged mesh to draw mesh
         * @param mergedMesh struct
         * @param geomMesh struct
         */
        void convertMergedMeshToGeomMesh(MergedMesh &mergedMesh, GeomMesh &geomMesh);

        void readGeomMeshFromIronHarvestMesh(const std::string &filename, GeomMesh &geomMesh);
